        ...
        children: [
          ClipRect(
            child: TweenAnimationBuilder<double>(
              tween: Tween(begin: reduceMotionOf(context) ? 1.0 : 0.0, end: 1),
              duration: motionOf(
                context,
                Duration(milliseconds: film ? 900 : 1100),
              ),
  ...
  Widget build(BuildContext context) => Wrap(
    ...
    children: [
      ...
      if (hint != null)
        Text(
          hint!,
          style: const TextStyle(fontSize: 10, color: Color(0xFF9F98AA)),
        ),
    ],
  );
}
