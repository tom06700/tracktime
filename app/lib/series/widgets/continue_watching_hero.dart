  ...
  Future<void> _mark() async {
    ...
    try {
      await Future<void>.delayed(
        motionOf(context, const Duration(milliseconds: 240)),
      );
      if (!mounted) return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Impossible d’enregistrer. Réessaie.')),
      );
    } finally {
            ...
            builder: (context, constraints) {
              ...
              final watched = OutlinedButton.icon(
                ...
                icon: AnimatedSwitcher(
                  ...
                  child: Icon(
                    _saving ? Icons.done_all : Icons.check,
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  disabledForegroundColor: NitrateBrand.ivory,
                  minimumSize: const Size(0, 50),
                  ...
                  side: BorderSide(color: Colors.white.withValues(alpha: .23)),
                  shape: const StadiumBorder(),
                ),
              );
