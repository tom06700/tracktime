...
class _NotificationScreenState extends State<NotificationScreen>
  ...
  void _tick(Duration elapsed) {
    ...
    _previous = elapsed;
    if (previous != null) {
      _clock.value += ((elapsed - previous).inMicroseconds / 1000000).clamp(
        0.0,
        .06,
      );
    }
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: NitrateHomeButton(
                      enabled: !_busy,
                      beforeHome: widget.onFinish,
                    ),
                  ),
                  Text(
                    _result ? '' : '02 / 02',
              ...
              if (!_result) ...[
                      ...
                      child: LayoutBuilder(
                        builder: (context, c) => SizedBox(
                          ...
                          child: OverflowBox(
                            ...
                            child: SizedBox(
                              width: c.maxWidth + 18,
                              child: NotificationScene(clock: _clock),
                            ),
                          ),
                        ),
                      ),
                ...
                const Text(
                  'Pas de spoilers. Juste l’essentiel.',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 11, color: Color(0xFFD1CBDC)),
                ),
                ...
                Center(
                  child: Container(
                    ...
                    child: Icon(
                      _allowed ? Icons.check : Icons.notifications_off_outlined,
                ...
                const SizedBox(height: 30),
                Text(
                  _allowed ? 'Autorisation accordée.' : 'À ton rythme.',
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                    fontSize: 30,
                    height: 1.2,
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: Color(0xFFAAA7B1), height: 1.7),
                ),
                ...
                if (_status == NotificationAccess.denied)
                  TextButton(
                    onPressed: _settings,
                    child: const Text('Réglages des notifications'),
                  ),
              ],
              if (_error != null)
                Semantics(
  ...
  Widget _primary(
    ...
    builder: (context, _) {
      ...
      final angle = ring < .48 ? math.sin(ring / .48 * math.pi * 6) * .23 : 0.0;
