...
class WelcomeScreen extends StatefulWidget {
  const WelcomeScreen({super.key, required this.onFinish, this.onHome});
  final Future<void> Function() onFinish;
                            ...
                            children: [
                              Flexible(
                                child: NitrateHomeButton(
                                  size: 25,
                                  enabled: !_busy,
                                  beforeHome: widget.onHome ?? widget.onFinish,
                                ),
                              ),
                              TextButton(
                ...
                AnimatedBuilder(
                  ...
                  child: const Column(
                    children: [
                      ...
                      SizedBox(height: 17),
                      Text(
                        'Garde le fil de ce que tu regardes.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontSize: 13,
                            ...
                            Positioned.fill(
                              child: IgnorePointer(
                                child: LayoutBuilder(
                                  builder: (context, c) {
                                    final phase =
                                        ((_clock.value - 1.5) / 6.5).clamp(
                                          0.0,
                                          double.infinity,
                                        ) %
                                        1;
                                    final t = ((phase - .68) / .22).clamp(
                                      0.0,
                                      1.0,
                                    );
                                    return Transform.translate(
                                      offset: Offset(
                                        (t * 2.8 - 1.4) * c.maxWidth,
                                        0,
                                      ),
                            ...
                            child: Align(
                              ...
                              child: FractionallySizedBox(
                                ...
                                child: const SizedBox(
                                  height: 3,
                                  child: ColoredBox(color: Color(0xFFA9B7DE)),
                                ),
                              ),
                            ),
                          ),
