...
export function sample(kind,a,b,t,{index=0,focus=0,viewport=390}={}){
 ...
 let p=kind==='cascade'?expo(t):spring(t);let x=mix(a.left,b.left,p),y=mix(a.top,b.top,p),w=mix(a.width,b.width,p),h=mix(a.height,b.height,p),radius=mix(a.radius,b.radius,clamp(p)),rotation=0;
 if(kind==='arc'){
